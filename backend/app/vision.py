...
def _call_openai_vision(b64: str) -> dict:
    ...
    prompt = (
        ...
        "Do NOT default to 'Pikachu' or any other pokemon if you cannot read the name.\n"
        "2. **Layout Variations**:\n"
        "   - **Legacy Cards (WOTC, EX, Diamond & Pearl)**: The Set Symbol and Card Number are often located on the RIGHT side, "
        "sometimes near the illustration or in the bottom right corner.\n"
        "   - **Newer Cards**: They are typically in the bottom left.\n"
        "3. **Card Name**: Located at the top of the card.\n"
        "4. **Card Number**: Look for 'XX/YYY' or 'XX'. Return ONLY the numerator (XX).\n"
        "5. **Set**: Identify the Set Name from the set symbol if possible. If visible, also extract the Set Code/Abbreviation.\n"
